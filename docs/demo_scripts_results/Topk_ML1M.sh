...
python main.py --model_name DIN --lr 2e-3 --l2 1e-6 --history_max 10 --dataset ML_1MTOPK --path ../data/MovieLens_1M --num_neg 1 --batch_size 256 --eval_batch_size 128 --metric NDCG,HR --topk 3,5,10,20 --include_item_features 1 --include_situation_features 1 --model_mode TopK --att_layers "[64,64,64]" --dnn_layers "[128,64]" --dropout 0.5
